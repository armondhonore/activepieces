# Nexlayer — activepieces

**Live:** [https://relaxed-weasel-activepieces.cloud.nexlayer.ai](https://relaxed-weasel-activepieces.cloud.nexlayer.ai)  
...
**activepieces** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/activepieces/activepieces:latest
    path: /
    servicePorts:
    - 80
    vars:
      AP_ENCRYPTION_KEY: "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4"
      AP_JWT_SECRET: "e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2"
      AP_POSTGRES_DATABASE: activepieces
      AP_POSTGRES_HOST: postgres.pod
      AP_POSTGRES_PORT: "5432"
      AP_POSTGRES_USERNAME: activepieces
      AP_POSTGRES_PASSWORD: "${POSTGRES_PASSWORD}"
      AP_REDIS_URL: "redis://redis.pod:6379"
      AP_FRONTEND_URL: "https://relaxed-weasel-activepieces.cloud.nexlayer.ai"
